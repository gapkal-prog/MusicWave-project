...
- Verification (2026-08-19): `tests/run.php` green with new regression coverage for playlist ownership/ordering/privacy/share-token rotation/release purge/export/erase, storage degradation before the 0.11.0 migration, wishlist/pre-save acceptance rules, catalog grouping, and pre-save fulfillment; phpcs 0 errors; phpstan 0 errors; 159-file syntax check; all three POT files regenerated. Documented in `docs/user-data-and-playlists.md`, `docs/data-dictionary.md`, and `docs/extension-contracts.md`.

**Remaining:** catalog autocomplete/facets + search adapter boundary (6), large-dataset query benchmarks (7), playlist and pre-save UI surfaces in the theme, and wp-env verification of the 0.10.0/0.11.0 migrations, retention cron, and pre-save scheduled event.
