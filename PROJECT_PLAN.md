...
**Remaining:** large-dataset query benchmarks (7) — including whether native search needs the adapter — playlist, wishlist, and pre-save UI surfaces in the theme, and wp-env verification of the 0.10.0/0.11.0 migrations, retention cron, pre-save scheduled event, and the throttled discovery routes.
