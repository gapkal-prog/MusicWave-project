...
**Remaining:** recorded benchmark numbers from a real wp-env/CI run (harness and gate are in place; results not yet captured in this document), plus playlist, wishlist, and pre-save UI surfaces in the theme.
