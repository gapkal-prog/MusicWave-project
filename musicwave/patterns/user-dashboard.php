...
<p class="has-accent-strong-color has-text-color has-small-font-size"><?php echo esc_html__( 'موسیقی شما', 'musicwave' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'همه چیزهایی که دارید، آماده پخش است.', 'musicwave' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
